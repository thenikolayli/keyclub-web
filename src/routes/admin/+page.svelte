<script lang="ts">
  ...
  onMount(() => {
    document.title = "Beekeeper - Dashboard";
  });
  ...
  <section class="flex flex-1 items-center justify-center">
    <Card.Root class="w-full max-w-md">
      <Card.Header class="items-center text-center">
        ...
        <Card.Description>
          Your account doesn't have permission to use the admin panel. If you
          believe this is a mistake, contact the webmaster.
        </Card.Description>
      </Card.Header>
    </Card.Root>
  </section>
{:else}
  <section class="flex flex-col text-foreground">
    ...
    <p class="text-lg text-foreground mt-4">
      This is the Beekeeper admin panel. It has a list of utilities on the left.
      <br />
      Please let me know if you have any questions.
      <br />
      <span class="text-muted-foreground"
        >(Contact via Instagram @imnikolayli)</span
      >
    </p>
  </section>
{/if}
