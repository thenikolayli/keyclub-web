        ...
        <div class="flex animate-in fade-in slide-in-from-bottom-4 duration-500 flex-col items-center gap-6 rounded-2xl border border-stone-700 bg-stone-900 px-8 py-16 text-center shadow-lg">
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-stone-500">
                    An email is on its way to <span class="font-medium text-stone-200">{email}</span>.
                </p>
            </div>
    ...
    {:else}
        ...
        >
            ...
            <div class="flex items-center gap-3 border-b border-stone-700 px-8 pb-3 pt-8">
                ...
                <div>
                    <h3 class="font-bold-gothic text-xl text-stone-100">Send an Invite</h3>
            ...
            <div class="space-y-5 px-8 pb-6 pt-6">
                <div class="space-y-2">
                    <label class="text-sm font-medium text-stone-300" for="email">Email</label>
                    <Input id="email" bind:value={email} type="email" placeholder="name@example.com" />
                </div>

                <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-2">
                        <label class="text-sm font-medium text-stone-300" for="first-name">First name</label>
                        <Input id="first-name" bind:value={firstName} placeholder="Ada" />
                    </div>
                    <div class="space-y-2">
                        <label class="text-sm font-medium text-stone-300" for="last-name">Last name</label>
                        <Input id="last-name" bind:value={lastName} placeholder="Lovelace" />
                    </div>
                </div>

                <div class="space-y-2">
                    <label class="text-sm font-medium text-stone-300" for="role">Role</label>
                    <div class="relative">
                        <select
                            id="role"
                            bind:value={role}
