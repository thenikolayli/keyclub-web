<script lang="ts">
  ...
  import {
    addToCalendar,
    type AddToCalendarRequest,
  } from "$lib/functions/add_to_calendar";
...
<div class="mx-auto max-w-lg">
  {#if status === "success"}
    ...
    >
      ...
      <div>
        <h3 class="font-bold-gothic text-2xl text-stone-100">
          Added to calendar!
        </h3>
        ...
        <p class="mt-1 text-xs text-stone-500 break-all">
          <a
            ...
            class="underline hover:text-primary">{resultUrl}</a
          >
        </p>
      </div>
  ...
  {:else}
    ...
    >
      ...
      <div class="space-y-5 px-8 pb-6 pt-6">
        <div class="space-y-2">
          <label class="text-sm font-medium text-stone-300" for="url"
            >Event URL</label
          >
          <Input
            id="url"
