...
// Returns "YYYY-MM-DD" or null if it cannot be parsed.
export function parseDateField(dateStr: string): string | null {
...
// Times are always in LA time. Returns null if it cannot be parsed.
export function parseTimeField(timeStr: string): string | null {
